...
const Calculate = () => {
    ...
    return (
        <>
            <div className="mt-3 p-3 sm:p-6 rounded shadow-lg border border-gray-200 max-w-md w-5/6 sm:w-full mx-auto bg-black hover:ring-yellow-500 hover:ring-4 hover:ring-inset">
